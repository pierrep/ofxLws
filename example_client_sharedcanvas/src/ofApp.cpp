  ...
  try{
    ...
    if ( !args.json.is_null() ){
        if (!args.json["setup"].is_null()){
            ...
            int r = ofToInt(args.json["setup"]["color"]["r"].dump());
            int g = ofToInt(args.json["setup"]["color"]["g"].dump());
            int b = ofToInt(args.json["setup"]["color"]["b"].dump());
            d->color.set(r, g, b);
          ...
          cout << "received point" << endl;
            ...
            // for some reason these come across as strings via JSON.stringify!
            int r = ofToInt(args.json["color"]["r"].dump());
            int g = ofToInt(args.json["color"]["g"].dump());
            int b = ofToInt(args.json["color"]["b"].dump());
